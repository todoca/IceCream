...
export const tipoDocPago = [
  ...
  {
    value: "05",
    label: "BOLETO DE AVIACIÓN COMERCIAL PARA TRANSPORTE DE PASAJEROS",
  },
  { value: "09", label: "TICKET O CINTA EMITIDO POR MÁQUINA REGISTRADORA" },
  { value: "99", label: "OTROS DOCUMENTOS AUTORIZADOS POR LA SUNAT" },
];
export const mecanismoPago = [{ value: 1, label: "Paquete quirúrgico" }];
export const tipoMecanismoPago = [{ value: 1, label: "Paquete quirúrgico" }];
export const tipoIdentNota = [{ value: 1, label: "Nota de crédito" }];
export const motivoNota = [{ value: 1, label: "Descuento parcial" }];
export const indicadorFactGlobal = [{ value: 1, label: "Individual" }];
//General
export const tipoAfiliacionPaciente = [{ value: 1, label: "SCTR" }];

export const docAutorizacionPrestacion = [
  { value: 1, label: "Solicitud de Chequeo Médico / SITEDS" },
];

export const tipoCoberturaPrestacion = [{ value: 1, label: "Hospitalaria" }];
...
export const tipoHospitalizacion = [
  {
    value: 1,
    label:
      "Hospitalización Quirúrgica, se efectúa un procedimiento quirúrgico o de naturaleza obstetricia (cesáreas).",
  },
];
...
export const catalogo = [
  {
    value: 1,
    label:
      "Código de productos y servicios estándar de las Naciones Unidas (UNSPSC) según lo aprobado por la SUNAT.",
  },
];
export const tipoUnidadDispensacion = [{ value: 1, label: "Por empaque" }];
